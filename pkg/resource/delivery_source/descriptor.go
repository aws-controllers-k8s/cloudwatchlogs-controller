...
const (
	FinalizerString = "finalizers.cloudwatchlogs.services.k8s.aws/DeliverySource"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("deliverysources")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.DeliverySource{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.DeliverySource),
	}
}
