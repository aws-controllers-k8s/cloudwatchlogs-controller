...
// +kubebuilder:rbac:groups=cloudwatchlogs.services.k8s.aws,resources=deliverysources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudwatchlogs.services.k8s.aws,resources=deliverysources/status,verbs=get;update;patch
