...
func (in *LogGroupSpec) DeepCopyInto(out *LogGroupSpec) {
	*out = *in
	...
	if in.MetricFilters != nil {
		...
		*out = make([]*PutMetricFilterInput, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PutMetricFilterInput)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PutMetricFilterInput) DeepCopyInto(out *PutMetricFilterInput) {
	*out = *in
	if in.ApplyOnTransformedLogs != nil {
		in, out := &in.ApplyOnTransformedLogs, &out.ApplyOnTransformedLogs
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PutMetricFilterInput.
func (in *PutMetricFilterInput) DeepCopy() *PutMetricFilterInput {
	if in == nil {
		return nil
	}
	out := new(PutMetricFilterInput)
